...
class TestTableViews:
    ...
    def test_delete_table(self):
        selection = create_data_selection(self.client, self.validated_datasource, "/api/uploads/")
        response = self.client.get(f"/api/uploads/{self.validated_datasource.id}/selections/{selection['id']}/tables/")
        ...
        response = self.client.patch(
            f"/api/uploads/{self.validated_datasource.id}/selections/{selection['id']}/tables/{table_data['id']}/",
    ...
    def test_list_tables(self):
        selection = create_data_selection(self.client, self.datasource, "/api/uploads/")
        response = self.client.get(f"/api/uploads/{self.datasource.id}/selections/{selection['id']}/tables/")
        assert len(response.json()) == 2
    ...
    def test_table_r_friendly_preview(self):
        ...
        response = self.client.patch(
            f"/api/uploads/{self.validated_datasource.id}/selections/{selection['id']}/",
